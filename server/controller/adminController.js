...
exports.admin = async (req, res) => {
  ...
  exports.dashboard = async(req, res) => {
    ...
    const end=req.query.endDate
        ...
        let salesData = Orderdb.find({status:"Delivered"});
    ...
    const sales = await salesData.exec();        
     res.render("dashboard",{sales,cancelledOrder,pendingOrder,deliveredOrder, jan,feb,mar,april,may,june,admin,activeLink:"dashboard"});
  };
    ...
    const brandName = req.body.brandName; // Destructure request body
      ...
      try {
        ...
        if (existingUser) {
          ...
          res.render('addCategory',{brand,category,activeLink:'add-category',catMsg:"",msg:""})
    ...
    exports.updateProduct = async(req, res) => {
       ...
       exports.delete_brand=async(req,res)=>{
        try {
         ...
         if(pdt){
           const brand=await Branddb.find()
           const category= await Categorydb.find()
           res.render("addCategory",{category,activeLink:'add-category',brand,catMsg:"",msg:"cant delete already used Brand"})
         }else{
       ...
       exports.delete_category=async(req,res)=>{
        try {
         ...
         if(pdt){
           ...
           res.render("addCategory",{brand,activeLink:'add-category',category,msg:"",catMsg:"cant delete already used Brand"})
         }else{
      ...
      exports.edit_coupon=async(req,res)=>{
       ...
       exports.delete_image=async(req,res)=>{
        ...
        await Productdb.updateOne({_id:productId},{$pull:{image:imageId}})
       ...
       exports.edit_banner=async(req,res)=>{
        ...
        const banner=await Bannerdb.findByIdAndUpdate(id,req.body,{ useFindAndModify: false },{new:true})
        res.redirect('/banner-data')
       }
